...
void initScene(Shader ourShader)
{
    ...
    pickModels.push_back(Model("bat", "models/bat.obj", glm::vec3(5.0, 0.2, 3), glm::vec3(0, 0, 0), 0.0f, 0.3));
    pickModels.push_back(Model("bat2", "models/bat.obj", glm::vec3(0.7f, -1.5f, -0.5f), glm::vec3(0, -45, 23), 0.0f, 0.3));
    pickModels.push_back(Model("crate", "models/crate.obj", glm::vec3(10.0, 0.2, 3), glm::vec3(0, 0, 0), 0.0f, 0.6));
    pickModels.push_back(Model("crate2", "models/crate.obj", glm::vec3(1, -1.5f, -1), glm::vec3(0, 0, 0), 0.0f, 0.6));
...
void collisions()
{
    ...
    if (!isBatCollided || !pickObject)
        detectColls(&pickModels[4].collbox, pickModels[4].name, &camera, renderCollBox, collidedObject_callback);
    if (!isCrateCollided || !pickObject)
        detectColls(&pickModels[6].collbox, pickModels[6].name, &camera, renderCollBox, collidedObject_callback);
